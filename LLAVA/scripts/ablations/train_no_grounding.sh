...
deepspeed --num_gpus 6 llava/train/train_temporal_v2.py \
    --deepspeed scripts/zero2.json \
    --lora_enable True --lora_r 128 --lora_alpha 256 \
    --mm_projector_lr 2e-5 \
    --model_name_or_path lmsys/vicuna-7b-v1.5 \
    --pretrain_mm_mlp_adapter /raid/den365/RaDialog_v2/LLAVA/checkpoints/radialog_v2_custom/non_lora_trainables.bin \
    --version v1 \
    --data_path /raid/den365/RaDialog_v2/data/temporal_grounding/train_no_grounding.json \
    ...
    --output_dir /raid/den365/RaDialog_v2/LLAVA/checkpoints/ablation_no_grounding \
    ...
    --run_name ablation_no_grounding \
    --mv_type temporal
